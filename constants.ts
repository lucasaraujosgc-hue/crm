...
export const DEFAULT_KNOWLEDGE_RULES: KnowledgeRule[] = [
  {
    id: '1',
    motivoSituacao: 'Art. 27 - Inc. XVIII - MEI',
    diagnosis: 'O MEI ultrapassou o limite de faturamento ou de compras (20% acima do limite permito). A SEFAZ bloqueou a inscrição para impedir novas compras.',
    solution: 'É necessário realizar o desenquadramento do MEI e a migração para o Simples Nacional, além de apurar os impostos retroativos sobre o excesso.',
    salesPitch: 'Sua empresa cresceu e a SEFAZ travou suas compras. Se não regularizarmos agora, a dívida aumenta. Eu resolvo essa migração para o Simples Nacional rapidamente para você voltar a operar.',
    isActive: true
  },
  {
    id: '2',
    motivoSituacao: 'Art.27, inc XIX, a, Omisso EFD',
    diagnosis: 'Falta de envio da Escrituração Fiscal Digital (EFD) por 2 meses ou mais consecutivos.',
    solution: 'Envio imediato dos arquivos Sped Fiscal pendentes e verificação de multas por atraso.',
    salesPitch: 'Identifiquei que faltam declarações fiscais da sua empresa. Isso suspende sua inscrição e gera multas diárias. Consigo transmitir esses arquivos hoje e destravar sua empresa.',
    isActive: true
  },
  {
    id: '3',
    motivoSituacao: 'Art. 27 - Inc. I - Não Localizado',
    diagnosis: 'A fiscalização foi ao endereço cadastrado no CNPJ e não encontrou a empresa funcionando.',
    solution: 'Atualização cadastral de endereço (REDESIM) ou defesa administrativa comprovando o funcionamento no local (fotos, contas de consumo).',
    salesPitch: 'A fiscalização bateu na sua porta e não te encontrou, por isso inativaram sua Inscrição. Precisamos atualizar seu endereço na SEFAZ urgente ou apresentar defesa, senão o CNPJ será baixado.',
    isActive: true
  }
];
